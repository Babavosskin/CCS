            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+12072528470" className="flex items-start gap-3 group">
                  ...
                  <div>
                    <span className="text-blue-200 group-hover:text-white text-sm transition-colors block">(207) 252-8470</span>
                    <span className="text-blue-200 text-xs">Fax: (207) 601-3590</span>
                  </div>
                </a>
              </li>
              <li>
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-blue-200 text-sm">Mon–Fri: 9AM-5PM</span>
              </li>
            </ul>
          </div>
        </div>
